...
[//]: # (This is partially derived from https://github.com/tdcoin/tdcoin/blob/6579d80572d2d33aceabbd3db45a6a9f809aa5e3/CONTRIBUTING.md)

# Contributing to tdcoinjs-lib
Firstly in terms of structure, there is no particular concept of "tdcoinjs developers" in a sense of privileged people.
...
To contribute a patch, the workflow is as follows:
  ...
  1. Submit a pull request to https://github.com/tdcoinjs/tdcoinjs-lib
...
## We adhere to Tdcoin-Core policy
Tdcoin script payment/script templates are based on community consensus,  but typically adhere to tdcoin-core node policy by default.

- `tdcoinjs.script.decompile` is consensus bound only,  it does not reject based on policy.
- `tdcoinjs.script.compile` will try to adhere to tdcoin-core `IsStandard` policies rules. (eg. minimalpush in https://github.com/tdcoinjs/tdcoinjs-lib/pull/638)
...
#### TLDR
Where "standards compliant" refers to the default policies of tdcoin-core,  we adhere to the following:
