...
const pushdata = require('pushdata-tdcoin');
const typeforce = require('typeforce');

export type OpCode = number;
export const OPS = require('tdcoin-ops') as { [index: string]: OpCode };

const REVERSE_OPS = require('tdcoin-ops/map') as { [index: number]: string };
